 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --font C:/Bateau/anemometre/Square-EcranV3/assets/ARIAL.TTF -o C:/Bateau/anemometre/Square-EcranV3/assets\ui_font_Arial12.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/
